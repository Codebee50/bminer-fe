...
const CloudMiningOffers = () => {
  return (
    <SectionWrapper>
      <section id="cloud-mining-offers" className="w-full flex flex-col">
        ...
        <div className="p-[40px] rounded-[24px] border border-[#b5b5b5] flex flex-col mt-[100px] gap-5">
          ...
          <p className="text-[#5b5b5b] text-[20px]">
            ...
            information is derived from data currently available to Bitcoin
            miner, including the current mining difficulty. The projections are
            based on the forecasted price of BTC. It's important to note that
            this information does not guarantee future performance and should
            not be overly relied upon due to inherent uncertainties.
          </p>
        </div>
      </section>
    </SectionWrapper>
