...
const StableBottom = () => {
  return (
    <section className="bg-[#815aac] w-full mt-[100px]">
      <SectionWrapper pad={false}>
        <div className="relative w-full pt-[60px]">
          <div className="w-full">
            <div className="flex flex-col xl:w-[50%] z-5">
              <h1 className="text-[48px] mb-[15px] text-white font-medium">
                Simple Bitcoin Mining
              </h1>
              <p className="text-white text-[20px] mb-[35px]">
          ...
          <div className="xl:w-[50%] xl:absolute right-0 bottom-0">
            <img
              src="/simplebit.webp"
              className="overflow-clip w-full align-middle"
              alt=""
            />
          </div>
        </div>
