...
const ContactPage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-7xl">
      <h1 className="text-5xl font-bold text-gray-800 mb-16">Contact Us</h1>

      <div className="flex flex-col lg:flex-row bg-gray-50 rounded-lg overflow-hidden">
        {/* Left side - Quick information */}
        <div className="p-8 lg:p-12 lg:w-1/2">
          <h2 className="text-4xl font-bold text-darkmuted mb-8">Quick information</h2>

          <h3 className="text-xl font-medium text-darkmuted mb-6">Trading Way FZCO</h3>

          <div className="flex items-start mb-6">
            <MapPin className="text-purple-600 mr-3 mt-1 flex-shrink-0" size={24} />
            <p className="text-gray-600">
              Dubai Silicon Oasis, PO Box 341041 Dubai, UAE,
              <br />
        ...
        <div className="cus-grad p-8 lg:p-12 lg:w-1/2 text-white rounded-2xl">
          <h2 className="text-4xl font-bold mb-8">Have any questions?</h2>
