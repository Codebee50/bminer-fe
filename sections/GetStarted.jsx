...
const GetStarted = () => {
  ...
  return (
    <section className="w-full h-screen pt-[160px] pb-[64px]  justify-center">
      <div className="w-full max-w-[1300px] px-[50px] mx-auto">
        <div className="flex bg-[#f8f8f8] rounded-3xl p-[60px]">
          <div className="flex flex-col justify-end flex-[1_1]">
            <div className="relative h-[300px] block">
              ...
              <p className="absolute p-[8px] text-[14px] rounded-[8px] bg-faintpurple border-b border-b-faintpurple z-[4] backdrop-blur-[2px] right-[30%] top-[20%]">
                • Simple registration in 3 clicks
              </p>
              <p className="absolute p-[8px] text-[14px] rounded-[8px] bg-faintpurple border-b border-b-faintpurple z-[4] backdrop-blur-[2px] right-[20%] top-[35%]">
            ...
            <div className="flex flex-col">
              ...
              <h2 className="text-[48px] font-medium mb-[15px] text-[#373737]">
                How do i get started
              </h2>
              <p className="text-[#5b5b5b] text-[20px] mb-[35px] leading-[140%]">
          ...
          <div className="flex-[1_1] flex flex-col justify-between">
            {steps.map((step) => (
              <LandingConverts
                key={step.text}
                text={step.text}
